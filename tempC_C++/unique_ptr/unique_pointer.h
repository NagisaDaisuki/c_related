...
public:
	...
	// default constrcutor and one taking T* 
	unique_pointer() noexcept = default;
	explicit unique_pointer(T* up) noexcept : ptr(up) {}
	...
	// return the underlying swap pointer 
	...
	// return ptr and make ptr to nullptr
	T* release();
